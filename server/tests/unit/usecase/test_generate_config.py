...
def test_generate_config_total_cost_lower_than_budget():
    ...
    # Create test data
    test_cpu = Cpu(name="Test CPU", price=1000, score=85, ddr=4, socket="AM4")
    ...
    cpu_repo_mock.get_all_by_budget.return_value = [test_cpu]
    ...
    assert result.processingKit.cpu == test_cpu
